...
CREATE TABLE schedule_conditions (
  ...
  min_pizza_capable int NOT NULL DEFAULT 0 CHECK (min_pizza_capable >= 0),
  min_pasta_capable int NOT NULL DEFAULT 0 CHECK (min_pasta_capable >= 0),
  min_open_shift int NOT NULL DEFAULT 0 CHECK (min_open_shift >= 0),
  min_fulltime int NOT NULL DEFAULT 0 CHECK (min_fulltime >= 0),
  min_parttime int NOT NULL DEFAULT 0 CHECK (min_parttime >= 0),
  max_weekend_offs int NOT NULL DEFAULT 2 CHECK (max_weekend_offs >= 0),
  max_normal_offs int NOT NULL DEFAULT 8 CHECK (max_normal_offs >= 0),
  max_annual_offs int NOT NULL DEFAULT 1 CHECK (max_annual_offs >= 0),
  max_consecutive_days int NOT NULL DEFAULT 5 CHECK (max_consecutive_days >= 1),
